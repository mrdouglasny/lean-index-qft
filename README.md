...
| [ImperialCollegeLondon/FLT](https://github.com/ImperialCollegeLondon/FLT) | 470 | Fermat's Last Theorem (uses representation theory) |
...
| [HautevilleHouse/martingales-continuous-parameter-theorem-canonical-lane-mathlib](https://github.com/HautevilleHouse/martingales-continuous-parameter-theorem-canonical-lane-mathlib) | 110 |  |
| [HautevilleHouse/variational-methods-eigenvalues-operators-should-canonical-lane-mathlib](https://github.com/HautevilleHouse/variational-methods-eigenvalues-operators-should-canonical-lane-mathlib) | 110 |  |
| [HautevilleHouse/martingales-continuous-parameter-foundation-canonical-lane-mathlib](https://github.com/HautevilleHouse/martingales-continuous-parameter-foundation-canonical-lane-mathlib) | 106 |  |
| [HautevilleHouse/geometric-measure-integration-theory-integral-canonical-lane-mathlib](https://github.com/HautevilleHouse/geometric-measure-integration-theory-integral-canonical-lane-mathlib) | 103 |  |
| [HautevilleHouse/distribution-primes-canonical-lane-mathlib](https://github.com/HautevilleHouse/distribution-primes-canonical-lane-mathlib) | 102 |  |
| [HautevilleHouse/martingales-discrete-parameter-lemma-canonical-lane-mathlib](https://github.com/HautevilleHouse/martingales-discrete-parameter-lemma-canonical-lane-mathlib) | 102 |  |
...
| [HautevilleHouse/distribution-primes-theorem-canonical-lane-mathlib](https://github.com/HautevilleHouse/distribution-primes-theorem-canonical-lane-mathlib) | 82 |  |
| [FredRaj3/SemicircleLaw](https://github.com/FredRaj3/SemicircleLaw) | 81 | Wigner semicircle law, random matrix theory |
| [HautevilleHouse/distribution-modulo-one-canonical-lane-mathlib](https://github.com/HautevilleHouse/distribution-modulo-one-canonical-lane-mathlib) | 75 |  |
| [HautevilleHouse/convergence-probability-measures-theorem-canonical-lane-mathlib](https://github.com/HautevilleHouse/convergence-probability-measures-theorem-canonical-lane-mathlib) | 75 |  |
| [HautevilleHouse/martingales-classical-analysis-lemma-canonical-lane-mathlib](https://github.com/HautevilleHouse/martingales-classical-analysis-lemma-canonical-lane-mathlib) | 73 |  |
| [oliver-butterley/SpectralThm](https://github.com/oliver-butterley/SpectralThm) | 69 | Spectral theorem formalization |
| [HautevilleHouse/banach-steinhaus-theorem-canonical-lane-mathlib](https://github.com/HautevilleHouse/banach-steinhaus-theorem-canonical-lane-mathlib) | 66 | Banach–Steinhaus theorem (uniform boundedness principle) — a family of... |
| [HautevilleHouse/distribution-modulo-one-theorem-canonical-lane-mathlib](https://github.com/HautevilleHouse/distribution-modulo-one-theorem-canonical-lane-mathlib) | 65 |  |
| [HautevilleHouse/distribution-prime-ideals-canonical-lane-mathlib](https://github.com/HautevilleHouse/distribution-prime-ideals-canonical-lane-mathlib) | 63 |  |
| [HautevilleHouse/martingales-continuous-parameter-lemma-canonical-lane-mathlib](https://github.com/HautevilleHouse/martingales-continuous-parameter-lemma-canonical-lane-mathlib) | 62 |  |
| [HautevilleHouse/estimates-eigenvalues-context-pdes-canonical-lane-mathlib](https://github.com/HautevilleHouse/estimates-eigenvalues-context-pdes-canonical-lane-mathlib) | 56 |  |
| [HautevilleHouse/boundary-eigenvalue-problems-ordinary-differential-canonical-lane-mathlib](https://github.com/HautevilleHouse/boundary-eigenvalue-problems-ordinary-differential-canonical-lane-mathlib) | 53 |  |
| [leanprover/SampCert](https://github.com/leanprover/SampCert) | 52 | Certified differential privacy sampling |
...
| [HautevilleHouse/eigenvalues-singular-values-eigenvectors-canonical-lane-mathlib](https://github.com/HautevilleHouse/eigenvalues-singular-values-eigenvectors-canonical-lane-mathlib) | 18 |  |
| [verified-optimization/CvxLean](https://github.com/verified-optimization/CvxLean) | 16 | Convex optimization, functional analysis |
| [AdrianGR517/HilbertSpacesLean4](https://github.com/AdrianGR517/HilbertSpacesLean4) | 14 | Formalization of Hilbert Spaces and the Riesz Representation Theorem in Lean 4 |
| [HautevilleHouse/students-t-distribution-canonical-lane-mathlib](https://github.com/HautevilleHouse/students-t-distribution-canonical-lane-mathlib) | 10 | Canonical-lane mathlib package for students-t-distribution |
...
| [HautevilleHouse/representations-locally-compact-groups-foundation-canonical-lane-mathlib](https://github.com/HautevilleHouse/representations-locally-compact-groups-foundation-canonical-lane-mathlib) | 7 |  |
| [HautevilleHouse/representations-locally-compact-groups-lemma-canonical-lane-mathlib](https://github.com/HautevilleHouse/representations-locally-compact-groups-lemma-canonical-lane-mathlib) | 7 |  |
| [HautevilleHouse/generalizations-martingales-canonical-lane-mathlib](https://github.com/HautevilleHouse/generalizations-martingales-canonical-lane-mathlib) | 7 |  |
| [HautevilleHouse/probability-measures-groups-semigroups-fourier-theorem-canonical-lane-mathlib](https://github.com/HautevilleHouse/probability-measures-groups-semigroups-fourier-theorem-canonical-lane-mathlib) | 7 |  |
| [HautevilleHouse/probability-measures-groups-semigroups-fourier-lemma-canonical-lane-mathlib](https://github.com/HautevilleHouse/probability-measures-groups-semigroups-fourier-lemma-canonical-lane-mathlib) | 7 |  |
| [HautevilleHouse/probability-measures-groups-semigroups-fourier-foundation-canonical-lane-mathlib](https://github.com/HautevilleHouse/probability-measures-groups-semigroups-fourier-foundation-canonical-lane-mathlib) | 7 |  |
...
| [HautevilleHouse/eigenvalue-problems-canonical-lane-mathlib](https://github.com/HautevilleHouse/eigenvalue-problems-canonical-lane-mathlib) | 7 |  |
| [HautevilleHouse/eigenvalues-estimation-eigenvalues-upper-lower-theorem-canonical-lane-mathlib](https://github.com/HautevilleHouse/eigenvalues-estimation-eigenvalues-upper-lower-theorem-canonical-lane-mathlib) | 7 |  |
| [HautevilleHouse/eigenvalues-estimation-eigenvalues-upper-lower-lemma-canonical-lane-mathlib](https://github.com/HautevilleHouse/eigenvalues-estimation-eigenvalues-upper-lower-lemma-canonical-lane-mathlib) | 7 |  |
| [HautevilleHouse/eigenvalues-estimation-eigenvalues-upper-lower-foundation-canonical-lane-mathlib](https://github.com/HautevilleHouse/eigenvalues-estimation-eigenvalues-upper-lower-foundation-canonical-lane-mathlib) | 7 |  |
...
| [cameronfreer/loeb-measure](https://github.com/cameronfreer/loeb-measure) | 1 | Loeb measure, ultraproduct probability, and applications to exchangeability and... |
| [JamesSquires0/Von_Neumann_Quantum_Logic_Formalization](https://github.com/JamesSquires0/Von_Neumann_Quantum_Logic_Formalization) | 1 | We formalize Von Neumann's quantum logic (non-distributive lattice of Hilbert... |
| [mrdouglasny/GFF](https://github.com/mrdouglasny/GFF) | 1 | Gaussian free field |
