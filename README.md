...
**67,325 topic-matched declarations** across **41 repositories** (scanned 53 repos, 89,493 declarations).
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 50,231 | The math library for Lean 4 (indexed via cache, not cloned) |
| [lean-phys-community/PhysLean](https://github.com/lean-phys-community/PhysLean) | 6,509 | Digitalized physics results in Lean (492 stars) |
...
| [xiyin137/OSreconstruction](https://github.com/xiyin137/OSreconstruction) | 958 | Osterwalder-Schrader reconstruction theorem |
| [cameronfreer/exchangeability](https://github.com/cameronfreer/exchangeability) | 815 | Exchangeability, de Finetti's theorem |
| [mrdouglasny/gaussian-field](https://github.com/mrdouglasny/gaussian-field) | 765 | Gaussian free field formalization |
| [or4nge19/SpinGlass](https://github.com/or4nge19/SpinGlass) | 670 | Spin glass models, statistical mechanics |
| [RemyDegenne/brownian-motion](https://github.com/RemyDegenne/brownian-motion) | 660 | Construction of a Brownian Motion in Lean |
...
| [xiyin137/StochasticPDE](https://github.com/xiyin137/StochasticPDE) | 469 | Stochastic PDEs |
| [teorth/analysis](https://github.com/teorth/analysis) | 336 | Tao's analysis formalization |
...
| [slink/LeanLevy](https://github.com/slink/LeanLevy) | 218 | Levy processes on Mathlib |
...
| [kebekus/ProjectVD](https://github.com/kebekus/ProjectVD) | 27 | Value distribution theory |
...
| [formalproofs/probability](https://github.com/formalproofs/probability) | 6 | Probability theory fundamentals |
