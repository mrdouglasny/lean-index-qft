...
**71,856 topic-matched declarations** across **50 repositories** (scanned 68 repos, 108,990 declarations).
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 53,728 | The math library for Lean 4 (indexed via cache, not cloned) |
| [lean-phys-community/PhysLean](https://github.com/lean-phys-community/PhysLean) | 3,529 | Digitalized physics results in Lean (492 stars) |
| [xiyin137/OSreconstruction](https://github.com/xiyin137/OSreconstruction) | 2,937 | Osterwalder-Schrader reconstruction theorem |
...
| [mrdouglasny/gaussian-field](https://github.com/mrdouglasny/gaussian-field) | 1,636 | Gaussian free field formalization |
| [cameronfreer/exchangeability](https://github.com/cameronfreer/exchangeability) | 811 | Exchangeability, de Finetti's theorem |
| [RemyDegenne/brownian-motion](https://github.com/RemyDegenne/brownian-motion) | 700 | Construction of a Brownian Motion in Lean |
...
| [mrdouglasny/pphi2](https://github.com/mrdouglasny/pphi2) | 632 | Construction of phi^4_2 quantum field theory in Lean 4 |
...
| [slink/LeanLevy](https://github.com/slink/LeanLevy) | 315 | Levy processes on Mathlib |
...
| [RemyDegenne/lean-bandits](https://github.com/RemyDegenne/lean-bandits) | 216 | Bandit algorithms, probability bounds |
...
| [kebekus/ProjectVD](https://github.com/kebekus/ProjectVD) | 19 | Value distribution theory |
| [verified-optimization/CvxLean](https://github.com/verified-optimization/CvxLean) | 16 | Convex optimization, functional analysis |
| [bjoernkjoshanssen/CramerLundberg](https://github.com/bjoernkjoshanssen/CramerLundberg) | 11 | Cramér-Lundberg distribution in Lean |
...
| [formalproofs/probability](https://github.com/formalproofs/probability) | 7 | Probability theory fundamentals |
...
| [SmaniaD/UnconditionalSchauderBasis](https://github.com/SmaniaD/UnconditionalSchauderBasis) | 2 | A Lean 4/mathlib project formalizing Schauder bases and unconditional Schauder... |
