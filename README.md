...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 50,052 | The math library for Lean 4 (indexed via cache, not cloned) |
| [lean-phys-community/PhysLean](https://github.com/lean-phys-community/PhysLean) | 6,450 | Digitalized physics results in Lean (492 stars) |
| [SStarrySSky/Measure](https://github.com/SStarrySSky/Measure) | 1,814 | 📏 A dependently-typed language on Lean 4 for formalizing physics. Dimensions,... |
| [xiyin137/OSreconstruction](https://github.com/xiyin137/OSreconstruction) | 932 | Osterwalder-Schrader reconstruction theorem |
| [cameronfreer/exchangeability](https://github.com/cameronfreer/exchangeability) | 818 | Exchangeability, de Finetti's theorem |
| [mrdouglasny/gaussian-field](https://github.com/mrdouglasny/gaussian-field) | 764 | Gaussian free field formalization |
| [or4nge19/SpinGlass](https://github.com/or4nge19/SpinGlass) | 670 | Spin glass models, statistical mechanics |
| [themathqueen/monlib4](https://github.com/themathqueen/monlib4) | 647 | Von Neumann algebras, quantum information theory |
| [teorth/analysis](https://github.com/teorth/analysis) | 626 | Tao's analysis formalization |
| [RemyDegenne/brownian-motion](https://github.com/RemyDegenne/brownian-motion) | 583 | Construction of a Brownian Motion in Lean |
...
| [alexjgreig/QHL-Lean](https://github.com/alexjgreig/QHL-Lean) | 30 | Quantum Hoare logic |
