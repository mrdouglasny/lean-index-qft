...
**74,050 topic-matched declarations** across **52 repositories** (scanned 72 repos, 113,167 declarations).
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 54,274 | The math library for Lean 4 (indexed via cache, not cloned) |
| [lean-phys-community/PhysLean](https://github.com/lean-phys-community/PhysLean) | 3,582 | Digitalized physics results in Lean (492 stars) |
...
| [RemyDegenne/brownian-motion](https://github.com/RemyDegenne/brownian-motion) | 686 | Construction of a Brownian Motion in Lean |
...
| [cameronfreer/exchangeability](https://github.com/cameronfreer/exchangeability) | 470 | Exchangeability, de Finetti's theorem |
| [teorth/analysis](https://github.com/teorth/analysis) | 343 | Tao's analysis formalization |
| [slink/LeanLevy](https://github.com/slink/LeanLevy) | 343 | Levy processes on Mathlib |
...
| [RemyDegenne/lean-bandits](https://github.com/RemyDegenne/lean-bandits) | 229 | Bandit algorithms, probability bounds |
...
| [oliver-butterley/SpectralThm](https://github.com/oliver-butterley/SpectralThm) | 59 | Spectral theorem formalization |
...
| [Robby955/formal-martingales](https://github.com/Robby955/formal-martingales) | 26 | Lean 4 library for martingale inequalities, anytime-valid inference, and... |
| [alexjgreig/QHL-Lean](https://github.com/alexjgreig/QHL-Lean) | 24 | Quantum Hoare logic |
| [kebekus/ProjectVD](https://github.com/kebekus/ProjectVD) | 21 | Value distribution theory |
