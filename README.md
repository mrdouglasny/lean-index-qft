...
**70,828 topic-matched declarations** across **48 repositories** (scanned 63 repos, 107,046 declarations).
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 53,345 | The math library for Lean 4 (indexed via cache, not cloned) |
| [lean-phys-community/PhysLean](https://github.com/lean-phys-community/PhysLean) | 3,467 | Digitalized physics results in Lean (492 stars) |
| [xiyin137/OSreconstruction](https://github.com/xiyin137/OSreconstruction) | 2,867 | Osterwalder-Schrader reconstruction theorem |
...
| [mrdouglasny/gaussian-field](https://github.com/mrdouglasny/gaussian-field) | 1,506 | Gaussian free field formalization |
...
| [mrdouglasny/pphi2](https://github.com/mrdouglasny/pphi2) | 504 | Construction of phi^4_2 quantum field theory in Lean 4 |
...
| [slink/LeanLevy](https://github.com/slink/LeanLevy) | 303 | Levy processes on Mathlib |
...
| [RemyDegenne/lean-bandits](https://github.com/RemyDegenne/lean-bandits) | 191 | Bandit algorithms, probability bounds |
...
| [or4nge19/MCMC](https://github.com/or4nge19/MCMC) | 106 | Markov chain Monte Carlo |
...
| [kebekus/ProjectVD](https://github.com/kebekus/ProjectVD) | 25 | Value distribution theory |
...
| [bjoernkjoshanssen/CramerLundberg](https://github.com/bjoernkjoshanssen/CramerLundberg) | 10 | Cramér-Lundberg distribution in Lean |
...
| [Abraxas1010/persistent-sheaf-laplacian](https://github.com/Abraxas1010/persistent-sheaf-laplacian) | 3 | Machine-checked proof that the persistent sheaf Laplacian is independent of... |
