...
**80,179 topic-matched declarations** across **64 repositories** (scanned 92 repos, 128,603 declarations).
...
|-----------|:---:|-------------|
| [leanprover-community/mathlib4](https://github.com/leanprover-community/mathlib4) | 55,758 | The math library for Lean 4 (indexed via cache, not cloned) |
| [lean-phys-community/PhysLean](https://github.com/lean-phys-community/PhysLean) | 4,292 | Digitalized physics results in Lean (492 stars) |
...
| [RemyDegenne/brownian-motion](https://github.com/RemyDegenne/brownian-motion) | 1,059 | Construction of a Brownian Motion in Lean |
...
| [cameronfreer/computable-analysis](https://github.com/cameronfreer/computable-analysis) | 232 | Computable analysis in Lean 4: represented spaces over a Type-2 oracle machine,... |
...
| [kebekus/ProjectVD](https://github.com/kebekus/ProjectVD) | 92 | Value distribution theory |
| [FredRaj3/SemicircleLaw](https://github.com/FredRaj3/SemicircleLaw) | 81 | Wigner semicircle law, random matrix theory |
| [oliver-butterley/SpectralThm](https://github.com/oliver-butterley/SpectralThm) | 70 | Spectral theorem formalization |
...
| [HautevilleHouse/f-distribution-canonical-lane-mathlib](https://github.com/HautevilleHouse/f-distribution-canonical-lane-mathlib) | 10 | Canonical-lane mathlib package for f-distribution |
...
| [HautevilleHouse/banach-steinhaus-theorem-canonical-lane-mathlib](https://github.com/HautevilleHouse/banach-steinhaus-theorem-canonical-lane-mathlib) | 2 | Banach–Steinhaus theorem (uniform boundedness principle) — a family of... |
